...
echo "ID,Name,Assignment,Deadline,Status" > "$dirName/assets/submissions.txt"
echo "123,John Doe,Lab 1,2025-02-25,Pending" >> "$dirName/assets/submissions.txt"
echo "124,Jane Smith,Lab 2,2025-02-26,Completed" >> "$dirName/assets/submissions.txt"
echo "125,Bob Brown,Lab 3,2025-02-27,Pending" >> "$dirName/assets/submissions.txt"
echo "127,Charlie Black,Lab 5,2025-03-01,Pending" >> "$dirName/assets/submissions.txt"
